...
- [ ]  `r advdate(dayone, 3, topic)`
  ...
  - Finish portfolio piece 1 by `r advdate(dayone, 15, assignment="f")`
...
- [ ] `r advdate(dayone, 5, topic)`
  ...
  - Finish portfolio piece 2 by `r advdate(dayone, 15, assignment="f")`
...
- [ ] `r advdate(dayone, 7, topic)`
  ...
  - Finish portfolio piece 3 by `r advdate(dayone, 15, assignment="f")`
